...
function findNews(el) {
    articleModel.getArticle(el.dataset.id).then(
        article => {
            ...
            document.querySelector('.f-news').setAttribute('id', article._id);
            ...
            document.querySelector('.dat').textContent = formatDate(new Date(article.createdAt));
